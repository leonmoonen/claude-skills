...
- **Numbers across text, tables, and figures**: Do values reported in the text match what's in the tables? Do the figures reflect the data described?
- **Statistical consistency**: Do p-values, confidence intervals, and effect sizes align? Are sample sizes consistent throughout?
- **Calculations**: Verify percentages, averages, and sums. Check that reported improvements (e.g., "30% improvement") match the actual numbers.
...
Use the following template for the review:
